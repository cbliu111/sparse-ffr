...
from utils.log import RootLogger, set_log_file, set_log_level
...
class Verbosity(IntEnum):
    ...
    def level(self) -> int:
        ...
        return getLevelName(VERBOSITY_TO_LOGLEVEL[self.name])
...
class Config:
    ...
    def __init__(
            ...
            *,
            ...
            plot_suffix: str = "",
            file_formate_data: str = "h5ad",
            file_formate_figs: str = "pdf",
            autosave: bool = False,
            autoshow: bool = True,
            writedir: Path | str = "./write/",
            cachedir: Path | str = "./cache/",
            datasetdir: Path | str = "./dataset/",
            figdir: Path | str = "./figures/",
            cache_compression: str | None = "gzip",
            max_memory=15,
        ...
        self.file_format_data = file_formate_data
        self.file_format_figs = file_formate_figs
        ...
        # warn for low resolution when saving figures
    ...
    def verbosity(self, verbosity: Verbosity | int | str):
        verbosity_str_options = [
            v for v in VERBOSITY_TO_LOGLEVEL if isinstance(v, str)
        ]
        ...
        set_log_level(self, VERBOSITY_TO_LOGLEVEL[self._verbosity.name])
